function jobObj = my_dfevalasync(dfcn, numArgOut, varargin)
%the same as the canonical, but it does not install an error handler
...
% Finish the initalization of the scheduler object.  This is a no-op for 
